...
//****** Store Frontend JS - spinner-restrict.js GH v.6.0.0-new-ui - Build ver 1.0.30 *********************************************************************************
//****** Updated at: 02-Sept-2021, 11:54 AM - Upon closing spinner, don't open spinner for 60 min - Done by @Farooq *****************************************************
...
(function () {
	...
	var CDN_WHEELIFY_URL = 'https://cdn.jsdelivr.net/gh/carecartapp/app-wheelify@1.0.30/';
...
//*************** Set Start Timer to Calculate time since Wheel has been Spun to get Discount Code ************************
				...
				function SASGoingToShow() {
					...
					if (spinnerShowTime == undefined){return true;}
					else if (minutes >= 60){return true;}
					else {return false;}
				}
...
//********************** In mobile view, hide the Spinner Trigger Text and display ONLY the wheel ***********************************
				...
				if (Shopify.shop == 'gammalife.myshopify.com') {
					...
					} else{carecartSpinnerJquery('head').append('<style type="text/css">#wheelify-spin-trigger-cc {bottom: 4vh !important;}</style>');}
				}
